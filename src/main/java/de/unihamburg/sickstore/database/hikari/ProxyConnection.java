...
public class ProxyConnection implements Connection
{
   ...
   private final FastList<ClientRequest> openStatements;
   ...
   protected ProxyConnection(final PoolEntry poolEntry, final SickConnection connection, final FastList<ClientRequest> openStatements, final ProxyLeakTask leakTask, final long now, final boolean isReadOnly, final boolean isAutoCommit) {
   ...
   final synchronized void untrackStatement(final ClientRequest statement)
   {
   ...
   private synchronized <T extends ClientRequest> T trackStatement(final T statement)
   {
   ...
   // **********************************************************************
   public SickConnection.ResponseHandler write(SickConnection.ResponseCallback callback) {
       return delegate.write(callback);
   }
