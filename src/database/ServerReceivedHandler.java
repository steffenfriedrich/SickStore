...
public class ServerReceivedHandler extends Thread {
    ...
    public void run() {
        Long id = -1l;
        try {
            if (object instanceof ClientRequestGet) {
                ClientRequestGet request = (ClientRequestGet) object;
                ...
                ServerResponseGetColumn response = new ServerResponseGetColumn(id, entry);
