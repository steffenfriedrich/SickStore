package de.unihamburg.pimpstore.test;
...
public class MyTests extends TestSuite {
    ...
    public static TestSuite suite() throws IOException {
        ...
        // $JUnit-BEGIN$
        suite.addTests(de.unihamburg.pimpstore.backend.AllTests.suite());
        suite.addTests(de.unihamburg.pimpstore.database.AllTests.suite());
        // $JUnit-END$
        return suite;
    }
