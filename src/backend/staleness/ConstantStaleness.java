...
public class ConstantStaleness implements StalenessGenerator {
    ...
    /**the staleness in ms that a server experiences when reading data written by another server*/
    private long foreignReads=0;
    
    /**the staleness in ms that a server experiences when reading data written by itself*/
    ...
    /** 
     * @see backend.staleness.StalenessGenerator#get(int, database.messages.ClientRequest)
     */
    @Override
