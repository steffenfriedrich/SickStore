...
Download the latest Release [sickstore-1.9.2.tar.gz](http://nosqlmark.informatik.uni-hamburg.de/sickstore-1.9.2.tar.gz), [sickstore-1.9.2.zip](http://nosqlmark.informatik.uni-hamburg.de/sickstore-1.9.2.zip)  or grab dependency via Maven:
